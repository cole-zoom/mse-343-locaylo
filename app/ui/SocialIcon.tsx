...
type SocialIconType = 'google' | 'facebook' | 'apple';
...
export const SocialIcon: React.FC<SocialIconProps> = ({ type, onClick }) => {
  if (type === 'google') {
    return (
      <button 
        onClick={onClick}
        className="w-16 h-16 rounded-full border border-gray-200 flex items-center justify-center bg-white shadow-sm hover:bg-gray-50 active:scale-95 transition-all cursor-pointer"
      >
  ...
  if (type === 'facebook') {
    return (
      <button 
        ...
        className="w-16 h-16 rounded-full border border-gray-200 flex items-center justify-center bg-white shadow-sm hover:bg-gray-50 active:scale-95 transition-all cursor-pointer"
      >
        <svg viewBox="0 0 24 24" width="28" height="28" fill="#1877F2" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <button 
      ...
      className="w-16 h-16 rounded-full border border-gray-200 flex items-center justify-center bg-white shadow-sm hover:bg-gray-50 active:scale-95 transition-all cursor-pointer"
    >
      <svg viewBox="0 0 24 24" width="28" height="28" fill="black" xmlns="http://www.w3.org/2000/svg">
        <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.64 3.4 1.63-3.12 1.88-2.6 5.86.35 7.1-.64 1.55-1.49 3.04-2.4 4.28zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
      </svg>
    </button>
  );
};
